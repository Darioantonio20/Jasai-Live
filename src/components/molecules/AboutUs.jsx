    ...
    return ( 
        ...
        <div className="row">
          <div className="col-lg-4 text-center">
            <img className="rounded-circle" src={DarioFoto} alt="Imagen Darío" width="140" height="140"/>
            <h2>Darío Antonio Gutiérrez Álvarez</h2>
            <p>Scrum Master</p>
          </div>
          <div className="col-lg-4 text-center">
            <img className="rounded-circle" src={DavidFoto} alt="Generic placeholder image" width="140" height="140"/>
            <h2>Jesús David Ruiz Garcia</h2>
            <p>Scrum Team</p>
          </div>
          <div className="col-lg-4 text-center">
            <img className="rounded-circle" src={CarlosFoto} alt="Generic placeholder image" width="140" height="140"/>
