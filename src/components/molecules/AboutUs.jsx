...
function AboutUs() {
  ...
  const personas = [
    ...
    {
      nombre: 'Jesús David Ruiz Garcia',
      puesto: 'Scrum Team',
      foto: `${DavidFoto}`,
      facebookLink: 'https://www.facebook.com/JesuVid.RG',
      githubLink: 'https://github.com/Darioantonio20',
      linkedinLink: 'https://www.linkedin.com/in/dario-antonio-gutierrez-alvarez-41353a225/'
    },
    {
      nombre: 'Carlos Ivan Cruz Zarmiento',
        ...
        {personas.map((persona, index) => (
          <div className="col-md-4 d-flex justify-content-center" key={index}>
            <div className="cardAbout">
              ...
              <div className="cardAbout-title">{persona.nombre} <br/>
                <span>{persona.puesto}</span>
              </div>
              <div className="cardAbout-socials">
                <button className="cardAbout-socials-btn facebook">
                  <a href={persona.facebookLink}>
                    <svg className="icon" width="24" viewBox="0 0 24 24" id="Layer_21" height="24" data-name="Layer 21"><title></title><path d="M16.75,9H13.5V7a1,1,0,0,1,1-1h2V3H14a4,4,0,0,0-4,4V9H8v3h2v9h3.5V12H16Z"></path></svg>
                  </a>
                </button>
                <button className="cardAbout-socials-btn github">
                  <a href={persona.githubLink}>
                ...
                <button className="cardAbout-socials-btn linkedin">
                  <a href={persona.linkedinLink}>
